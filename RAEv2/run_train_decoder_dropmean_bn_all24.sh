#!/usr/bin/env bash
# ============================================================
#  ALL-LAYER dropmean stage-1 with the BN projector + global SIGReg
#  (src/train_decoder_mls_dropmean_bn_sigreg.py)
#
...
#  SIGReg:   pooled 8-GPU statistic (differentiable all-reduce)
...
OUT_DIR=output_full/train_decoder_mls_dropmean_bn_all24
...
echo "========================================================"
echo "  ALL-24-layer dropmean + BN projector + global SIGReg"
