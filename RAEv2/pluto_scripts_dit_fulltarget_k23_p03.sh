...
# Pluto "Scripts" field for DiT-B fulltarget k23 p_drop=0.3 on 8 GPUs (single replica).
# Pluto job: replicas = 1, GPUs/replica = 8  ->  NUM_NODES=1.
# Writes to ckpt/dit-b-omni-randomdrop-fulltarget-plain-k23-p0.3 (auto-resumes).
